        ...
        <div className="mt-8 flex gap-8 items-center">
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] text-stone-500 font-black uppercase">{pin.length >= 4 ? 'Valid' : 'Standby'}</span>
            </div>
          </div>
          <div className="w-px h-6 bg-stone-800/50"></div>
          <div className="flex flex-col items-center">
            <span className="text-[7px] text-stone-600 font-black uppercase tracking-widest mb-1">Link</span>
            <span className="text-[9px] text-stone-500 font-black uppercase">Encrypted</span>
          </div>
        </div>
      </div>
    </div>
